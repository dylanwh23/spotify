...
public interface IPlaylistController {
    ...
    public abstract Object[][] obtenerPlaylistListaPorId(int id);
    ...
    public abstract boolean esParticular(Integer id);

    public abstract String getPropietario(String id, String propietario);
